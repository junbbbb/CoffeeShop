...
public class AdminEmployeeManagePanel extends JPanel {
	 ...
	 * Create the panel.
	 */
	public AdminEmployeeManagePanel() {
	...
	private JLabel getLblNewLabel() {
		if (lblNewLabel == null) {
			...
			lblNewLabel.setIcon(new ImageIcon(AdminEmployeeManagePanel.class
					.getResource("/com/javalec/image/ExecStoreManagerPanelBrownbar.png")));
		}
		return lblNewLabel;
	}
